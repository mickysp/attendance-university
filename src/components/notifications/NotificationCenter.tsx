        ...
        <div className="flex h-full min-h-0 flex-col p-5 sm:p-6">
          <div className="mb-5 flex items-center justify-between gap-3 border-b border-gray-100 pb-4">
            ...
            <button
              ...
              className="flex h-9 w-9 shrink-0 cursor-pointer items-center justify-center rounded-full text-gray-500 transition hover:bg-gray-100 hover:text-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
              ...
              <ul className="space-y-1">
                {items.map((item) => {
                  ...
                  return (
                    <li
                      key={item.id}
                      className={`flex gap-3 rounded-xl p-3 ${item.unread ? "bg-blue-50/80" : "hover:bg-gray-50"}`}
                    >
                      <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-blue-600 shadow-sm ring-1 ring-gray-100">
