  ...
  return (
    <dialog
      ...
      onAnimationEnd={(event) => {
        if (event.animationName === "app-dialog-attention") event.currentTarget.classList.remove("app-dialog-attention");
      }}
    ...
    >
      <div className="mb-5 flex items-center justify-between gap-3 border-b border-gray-100 pb-4">
        <div className="flex items-center gap-3">
          ...
          <h2 id="profile-image-title" className="text-lg font-semibold text-gray-800">รูปโปรไฟล์</h2>
        </div>
        <button
          type="button"
          autoFocus
