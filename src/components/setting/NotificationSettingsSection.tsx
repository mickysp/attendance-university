...
const options: {
...
}[] = [
  {
    key: "accounts",
    label: "บัญชีผู้ใช้",
    description: "การเพิ่ม ลบ หรือเปลี่ยนสิทธิ์ผู้ดูแลระบบ",
  },
  {
    key: "classes",
    label: "ชั้นเรียน",
    description: "การสร้าง แก้ไข หรือลบชั้นเรียน",
  },
  {
    key: "students",
    label: "นักศึกษา",
    description: "การเพิ่ม แก้ไข หรือนำเข้าข้อมูลนักศึกษา",
  },
  {
    key: "attendance",
    label: "การเช็คชื่อ",
    description: "การแก้ไขข้อมูลการเข้าเรียนที่สำคัญ",
  },
];
      ...
      <div className="divide-y divide-gray-100 px-5 sm:px-6">
        {options.map((option) => (
          <SettingToggle
            ...
            disabled={saving}
            onChange={() =>
              void update({ ...settings, [option.key]: !settings[option.key] })
            }
          />
        ))}
